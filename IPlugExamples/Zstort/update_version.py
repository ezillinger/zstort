...
def main():
  ...
  plistpath = scriptpath + "/resources/Zstort-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Zstort-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Zstort-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Zstort-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Zstort-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Zstort-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Zstort.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Zstort.iss",inplace=1):
